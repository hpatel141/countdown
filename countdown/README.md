...
* Pick an area of improvement to implement. **(Making UI Better)**
* What would happen to the current code if the date were changed, the page layout was changed or the format was changed? **(if invalid date is there it will show message or else countdown continues)**
* Does the current implementation follow best practices for HTML, CSS, JS and React? **(updated the folder structure)**
